<?php
/**
*   Template Name: Welding
*/

get_header(); ?>

<main id="primary" class="site-main welding">
    ...
    <div class="ast-container">        
        ...
        <section class="image-grid">
            <img src="/wp-content/uploads/2024/12/Welding_1.jpg" alt="Image of a welding machine">
            <img src="/wp-content/uploads/2024/12/Welding_2.jpg" alt="A person welding a part">
        </section>
            ...
            <section class="content">
                ...
                <?php if ( get_field('content_text_footnote') ) : ?>
                    <div class="content__footer">
                        <p><?php the_field('content_text_footnote'); ?></p>
                    </div>
                <?php endif; ?>
            </section>
        <?php endif; ?>
